...
export const roles = [
	{
		...
		description:
			'Seeking experienced sailors who can ride along with our disabled sailors to make sure everyone has a safe and enjoyable time on the water.',
		src: companionImage
	},
	{
		title: 'Dock support',
		description:
			'Seeking abled bodied individuals to help transfer sailors from the docks into the boats, prepare the boats for launch, and land our boats safely when they return.',
		src: dockSupportImg
	},
	{
