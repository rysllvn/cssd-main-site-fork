...
<main class="w-full h-full mx-auto">
	<header id="header" class="w-full px-4 py-10 flex flex-col md:flex-row items-center gap-10">
		<img class="w-64 md:w-96 rounded-lg" src={logo} alt="Challenged Sailors San Diego Logo" />
		<div class="card card-hover flex flex-col gap-4 items-center variant-glass-primary p-4 shadow">
	...
	<section class="px-4 flex flex-col lg:flex-row items-center gap-4 justify-between lg:px-20">
		...
		<section class="card card-hover p-3 w-fit variant-glass-secondary flex flex-col text-white">
			...
			<hr />
			<p class="text">Volunteers and donations are welcome and appreciated</p>
			<div>
