...
<div id="background" class="w-full h-full">
	<div class="container w-full h-full max-w-screen-xl mx-auto mb-10 sm:py-10">
		<header
			id="header"
			class="mb-10 variant-glass-primary card text-white w-full px-4 py-6 flex flex-col md:flex-row items-center gap-10"
		>
		...
		<section class="px-4 flex flex-col lg:flex-row items-center gap-4 justify-between">
			...
			<div class="flex flex-col items-center gap-2">
				<section class="card p-3 w-fit variant-glass-secondary flex flex-col text-white">
		...
		<section class="flex flex-col items-center card variant-glass-primary mt-12 p-4">
			<h2 class="h2 mb-5 text-white">Testimonials</h2>
